 ...
 * creating the next attributes instance with the {@link #createRegionAttributes}
 ...
 * <h4>Distribution</h4>
 * <dl>
 * <dt>{@link Scope} [<em>default:</em> <code>Scope.DISTRIBUTED_NO_ACK</code>]</dt>
 ...
 *         Scope.DISTRIBUTED_NO_ACK and Scope.DISTRIBUTED_ACK have identical
...
class CPPCACHE_EXPORT AttributesFactory: public SharedBase {
 ...
 public:
   ...
   * @param persistenceManager a user defined PersistenceManager, NULLPTR if no resolver
   */
...
private:
  ...
  bool m_useDefaultClientNotification;
