...
class CPPCACHE_EXPORT SPEHelper
{
  ...
  static void throwClassCastException( const char* msg,
      const char* fromType, const char* toType );
};

/* Helper function template for type conversion.
 */
template< class Target, class Src > Target* getTargetHelper( Src* ptr, gemfire::TypeHelper::yes_type yes )
{
  return ptr;
}
...
/* Helper function template for type conversion.
 */
template< class Target, class Src > Target* getTargetHelper( Src* ptr, gemfire::TypeHelper::no_type no )
{
...
/* Helper function template for type conversion.
 */
template< class Target, class Src > Target* getTarget( Src* ptr )
{
...
/* Helper function template for type conversion.
 */
template< class Src > SharedBase* getSB( Src* ptr )
{
