...
class CPPCACHE_EXPORT PdxWrapper : public PdxSerializable {
	 ...
	 * A user domain object should be wrapped in an instance of a PdxWrapper with a
...
public:
   ...
   * @param userObject the void pointer to an instance of a user object - NOTE: PdxWrapper takes ownership.
   * @param className the fully qualified class name to map this user object to the Java side.
   */
   ...
   * @param detach if set to true will release ownership of the object and future calls to getObject() return NULL.
   */
