...
class CPPCACHE_EXPORT PdxSerializer : public SharedBase {
	 ...
	 * of the domain class.
	 * A domain class should register function {@link Serializable::registerPdxSerializer} to create new
...
public:
  ...
  virtual void * fromData(const char * className, PdxReaderPtr pr) = 0;
	 ...
	 */
  virtual bool toData(void * userObject, const char * className, PdxWriterPtr pw) = 0;
   ...
   */
  virtual UserObjectSizer getObjectSizer(const char * className) { return NULL; };
