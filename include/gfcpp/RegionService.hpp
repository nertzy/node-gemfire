 ...
 * <ul>
 * <li> {@link CacheFactory#create()} creates a client instance of {@link Cache}.
 * <li> {@link Cache#createAuthenticatedView(Properties)} creates a client multiuser authenticated cache view.
 * </ul>
 * <p>
 *
 */
