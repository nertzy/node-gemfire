 ...
 *
 * To create an instance of this interface, use {@link CacheAttributesFactory::createCacheAttributes}.
 *
 * For compatibility rules and default values, see {@link CacheAttributesFactory}.
 *
 * <p>Note that the <code>CacheAttributes</code> are not distributed with the region.
 *
