...
class CPPCACHE_EXPORT RegionFactory: public SharedBase{
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setCacheLoader(const char* libpath, const char* factoryFuncName);

 /**
  * Sets the library path for the library that will be invoked for the writer of the region.
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setCacheWriter(const char* libpath, const char* factoryFuncName);

  /**
   * Sets the library path for the library that will be invoked for the listener of the region.
   * @return a reference to <code>this</code>
   */
  RegionFactoryPtr setCacheListener(const char* libpath, const char* factoryFuncName);

 /**
  * Sets the library path for the library that will be invoked for the partition resolver of the region.
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setPartitionResolver(const char* libpath, const char* factoryFuncName);
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setEntryIdleTimeout(ExpirationAction::Action action, int32_t idleTimeout);
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setEntryTimeToLive(ExpirationAction::Action action, int32_t timeToLive);
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setRegionIdleTimeout(ExpirationAction::Action action, int32_t idleTimeout);
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setRegionTimeToLive(ExpirationAction::Action action, int32_t timeToLive);
  ...
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setPersistenceManager(const char* libpath, const char* factoryFuncName,
      const PropertiesPtr& config = NULLPTR);

  /** Sets the PersistenceManager for the next <code>RegionAttributes</code> created.
  * @param persistenceManager a user defined PersistenceManager, NULLPTR if no persistenceManager
  * @return a reference to <code>this</code>
  */
  RegionFactoryPtr setPersistenceManager(const PersistenceManagerPtr& persistenceManager, 
      const PropertiesPtr& config = NULLPTR);
