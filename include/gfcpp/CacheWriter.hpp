 ...
 * over the network, (especially if they are not colocated on the nodes where the
 ...
 * of whether the initiator is in the same process as the <code>CacheWriter</code>.
 *
...
public:
   ...
   * @param event EntryEvent denotes the event object associated with clearing the region
   *
   * @see Region::clear
   */
   ...
   * @param event EntryEvent denotes the event object associated with destroying the region
   *
